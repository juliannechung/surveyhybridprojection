...
%
% For the deblurring example, this script uses GKB to estimate the 
...
% saveas(gcf,'figs/cov_blur.eps','epsc')
...
semilogy([infogk_wgcv_auto.its infogk_wgcv_auto.its],[10^-1 10^3],':k')
% legend('GKB','RSVD','','Location','east')
...
ylength = 400;
set(gcf,'Position',[100 100 xlength ylength])
% saveas(gcf,'figs/sumcov_blur.eps','epsc')
